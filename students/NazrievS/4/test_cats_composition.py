...
class CatsCompositionTests(unittest.TestCase):
    ...
    def test_main(self):
        ...
        assert os.path.isfile('temp/cat_1_fact.txt')
        assert os.path.isfile('temp/cat_1_image.jpg')
        assert os.stat('temp/cat_1_fact.txt').st_size != 0

    def test_integration(self):
        """Test func."""
        format_str = 'python students/NazrievS/4/cats_composition.py {0}'  # noqa E800
